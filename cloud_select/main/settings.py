...
import cloud_select.main.schemas
...
class Settings:
    ...
    def validate(self):
        ...
        """
        jsonschema.validate(
            instance=self._settings, schema=cloud_select.main.schemas.settings
        )
    ...
    def edit(self, settings_file=None):
        ...
        if not editor:
            logger.exit(
                "No editors found! Update with cloud_select config set config_editor:<name>"
            )
