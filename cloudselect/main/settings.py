...
import cloudselect.main.schemas
...
class Settings:
    ...
    def validate(self):
        ...
        """
        jsonschema.validate(
            instance=self._settings, schema=cloudselect.main.schemas.settings
        )
    ...
    def edit(self, settings_file=None):
        ...
        if not editor:
            logger.exit(
                "No editors found! Update with cloudselect config set config_editor:<name>"
            )
